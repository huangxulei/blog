...
import 'package:blog/page/main_page/widget/banner_widget.dart';
import 'package:blog/page/main_page/widget/main_article_item.dart';
import 'package:blog/page/main_page/widget/main_wechat_public_widget.dart';
                  ...
                  child: Container(
                      ...
                      child: RefreshWidget<MainController>(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          ///将Banner装载到ListView中
                          print('banner === ${controller.banner}');
                          if (index == 0) {
                            return Container(
                              margin:
