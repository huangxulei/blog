...
import 'package:blog/page/search_page/widget/search_result_item.dart';
...
class SearchResultWidget extends GetCommonView<SearchsController> {
  ...
  Widget build(BuildContext context) {
    return Obx(() => Visibility(
          ...
          child: Container(
              ...
              color: Colors.white,
              child: RefreshWidget<SearchsController>(
